  ...
  return (
    <div className="space-y-6 pb-24 md:pb-6 h-full flex flex-col justify-start">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        {/* Score Card 3: Burnout Risk Gauge */}
        <div className="glass-panel p-4 flex flex-col items-center text-center relative overflow-hidden bg-slate-900/60 border-slate-850">
